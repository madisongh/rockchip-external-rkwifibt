...
u8 rtw_init_default_value(_adapter *padapter)
{
	...
	padapter->fix_rx_ampdu_accept = _TRUE;
	padapter->fix_rx_ampdu_size = 8;
	padapter->driver_rx_ampdu_factor =  0x01; /*16k*/
#else
	...
	padapter->dis_turboedca = DIS_TURBO_USE_MANUAL;
	padapter->edca_param_mode = CONFIG_RTW_CUSTOMIZE_EDCA_MODE;
